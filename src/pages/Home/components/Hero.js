    ...
    <section className="mt-20 ">
      <div className="flex flex-col lg:flex-row  items-center">
        <div className="text my-5">
          ...
          <p className="text-2xl my-7 px-1 dark:text-slate-500">
          ...
          <Link
            to="/products"
            type="button"
            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-2 focus:ring-blue-100 font-medium rounded-lg text-base px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
          >
            Explore eBooks
          </Link>
        </div>
